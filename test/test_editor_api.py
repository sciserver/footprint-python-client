...
class TestEditorApi(unittest.TestCase):
    ...
    def test_get_footprint(self):
        ...
        self.assertEqual(self.ssclient.last_response.data, b'{\"footprint\":{\"name\":\"new_footprint\",\"combinationMethod\":1,\"comments\":\"\",\"public\":false},\"links\":{\"self\":\"http://CASTOR/footprint/api/v1/Footprint.svc/users/new_footprint\"}}')
